...
course_map={
         #course_code培训师联系方式   name培训项目名称       course_type（删除）       credit费用        limit_num弃用    course_week弃用        course_time弃用             class_room弃用         teaching_type培训方式          exam_type培训内容
    1 => {course_code: "13164639018", name: "竞赛项目的争取", credit: "50", exam_type: "以亲身经历传授如何取得数学建模竞赛的好成绩，附送大量资料"},
    2 => {course_code: "13164639018", name: "竞赛项目的争取", credit: "50", exam_type: "以亲身经历传授如何取得数学建模竞赛的好成绩，附送大量资料"},
    3 => {course_code: "13164639018", name: "竞赛项目的争取", credit: "50", exam_type: "以亲身经历传授如何取得数学建模竞赛的好成绩，附送大量资料"},
    4 => {course_code: "13164639018", name: "竞赛项目的争取", credit: "50", exam_type: "以亲身经历传授如何取得数学建模竞赛的好成绩，附送大量资料"},
    5 => {course_code: "13164639018", name: "竞赛项目的争取", credit: "50", exam_type: "以亲身经历传授如何取得数学建模竞赛的好成绩，附送大量资料"}
...
(1..200).each do |index|
  student=User.create!(
      ...
      num: "139#{Faker::Number.number(8)}",
      major: StudentGenerator.major,
      department: StudentGenerator.department,
      aim_major: StudentGenerator.major,
      aim_department: StudentGenerator.department,
      password: "password",
      password_confirmation: "password",
  )
